...
/* build-hook-start *//*00001*/try { require('/home/zoe/.vscode/extensions/wallabyjs.console-ninja-1.0.459/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2045dc69fd168894091493ARtVUwYXVF5TD14NDQZSWgkACAoC', mode: 'build'}); } catch(cjsError) { try { import('file:///home/zoe/.vscode/extensions/wallabyjs.console-ninja-1.0.459/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2045dc69fd168894091493ARtVUwYXVF5TD14NDQZSWgkACAoC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*
